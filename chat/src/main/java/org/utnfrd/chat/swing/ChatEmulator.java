...
buttonInitSession.setEnabled(false);
buttonCloseSession.setEnabled(false);
...
public class ChatEmulator extends JFrame implements ActionListener {
					...
					public void run(){
						...
						while(entrar) {
							...
							try {
								...
								String txt  =((textArea.getText().isEmpty())?"":textArea.getText() + System.lineSeparator());
								textArea.setText(										 
										txt
										+ listenMessage);
							} catch (Exception e) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!messageTextField.getText().isEmpty()) {
					...
					textArea.setText(textArea.getText() 
							+ ((textArea.getText().isEmpty())?"":System.lineSeparator())
	...
	private void sessionEnable(boolean b) {
		
		jRadioButtonTCP.setEnabled(!b);
		jRadioButtonUDP.setEnabled(!b);				
		buttonInitSession.setEnabled(!b);
		
		buttonCloseSession.setEnabled(b);

		messageTextField.setEnabled(b);
